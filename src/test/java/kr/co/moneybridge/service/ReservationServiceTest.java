...
public class ReservationServiceTest extends MockDummyEntity {
    ...
    public void get_reservation_base_test() {
        ...
        assertThat(baseDTO.getConsultInfo().getConsultStart()).isEqualTo(DateUtil.localTimeToString(pb.getConsultStart()));
        assertThat(baseDTO.getConsultInfo().getConsultEnd()).isEqualTo(DateUtil.localTimeToString(pb.getConsultEnd()));
