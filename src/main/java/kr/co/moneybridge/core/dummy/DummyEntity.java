...
public class DummyEntity {
    ...
    public PB newPB(String username, Branch branch) {
        ...
        return PB.builder()
                ...
                .phoneNumber("01012345678")
                .branch(branch)
                .profile("https://d2ky5wm6akosox.cloudfront.net/default/profile.svg")
                .businessCard("https://d2ky5wm6akosox.cloudfront.net/business-card/be1162a9-81a4-4869-a29c-70eb70c005a8_businessCard.png")
                .career(10)
